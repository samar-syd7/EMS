...
public class EmployeeManagementSystem {
	...
	public EmployeeManagementSystem(Connection con) {
		this.con = con;
	}
	...
	public void oneEmployeeHelper(int id, JFrame parentFrame) throws SQLException {
		JFrame frame = new JFrame("View " + id);
	...
	public void addEmployee() throws SQLException {
		...
		submitButton.addActionListener(actionListener -> {
			...
			String q = String.format("insert into employee values (%d, '%s', '%s', '%s', '%s', '%s', %f);", id, name,
					gender, phoneNum, email, designation, salary);
			try {
	...
	public void editEmployeeHelper(int id, JFrame parentFrame) throws SQLException {
		...
		submitButton.addActionListener(actionListener -> {
			...
			String query = String.format(
					...
					name, genderValSelectedItem, phoneNum, email, designation, salary, id);
			try {
	...
	public void mainMenu() {
		...
		viewEmpButton.setBounds(400, 130, 300, 40);
		...
		JButton oneEmpButton = new JButton("View an employee");
		oneEmpButton.setBounds(400, 200, 300, 40);
		oneEmpButton.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		oneEmpButton.setFocusPainted(false);
		oneEmpButton.addActionListener(actionEvent -> {
			try {
				oneEmployee();
			} catch (SQLException throwables) {
				throwables.printStackTrace();
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException {
		...
		String db_password = "kmb47x47sJv&";
